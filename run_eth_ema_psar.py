...
import pytz
from eth_ema_psar_bot import ETHEmaPsarBot
...
logging.basicConfig(
    filename=os.path.join(log_dir, f"eth_bot_debug_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"),
    level=logging.DEBUG,
...
def main():
    ...
    console.print("\n" + "="*50, style="blue")
    console.print(Align("ETH EMA-PSAR Trading Bot", align="center"), style="bold blue")
    console.print("="*50 + "\n", style="blue")
