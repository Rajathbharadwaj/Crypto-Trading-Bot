...
def main():
    ...
    parser = argparse.ArgumentParser(description='Reset BTC trading bot state')
    ...
    try:
        ...
        if not args.simulate_crossover:
            print("The bot will now start fresh with no active crossover signals.")
        else:
            print(f"The bot will now simulate a {args.simulate_crossover} crossover on next run.")
